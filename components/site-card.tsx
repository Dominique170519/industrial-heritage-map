...
function MetaTag({ children }: { children: React.ReactNode }) {
  return (
    <span className="rounded-full border border-stone-200 bg-stone-50 px-2.5 py-1 text-xs text-slate-700">
      {children}
    </span>
  );
}
...
export default function SiteCard({
  ...
  return (
    <article
      id={id}
      className={[
        "site-card-shell overflow-hidden rounded-[24px] border border-stone-200 bg-white shadow-[0_14px_34px_rgba(15,23,42,0.06)]",
